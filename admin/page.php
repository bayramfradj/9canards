...
if(isset($_POST['form_about'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            $Page->updateAbout1(array($_POST['about_title'],$_POST['about_content'],$final_name,$_POST['about_meta_title'],$_POST['about_meta_keyword'],$_POST['about_meta_description']));
        } else {
            // updating the database
            $Page->updateAbout2(array($_POST['about_title'],$_POST['about_content'],$_POST['about_meta_title'],$_POST['about_meta_keyword'],$_POST['about_meta_description']));
        }
...
if(isset($_POST['form_faq'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $Page->updateFaq1(array($_POST['faq_title'],$final_name,$_POST['faq_meta_title'],$_POST['faq_meta_keyword'],$_POST['faq_meta_description']));
        } else {
            // updating the database
            $Page->updateFaq2(array($_POST['faq_title'],$_POST['faq_meta_title'],$_POST['faq_meta_keyword'],$_POST['faq_meta_description']));
        }
...
if(isset($_POST['form_blog'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $Page->updateBlog1(array($_POST['blog_title'],$final_name,$_POST['blog_meta_title'],$_POST['blog_meta_keyword'],$_POST['blog_meta_description']));
        } else {
            // updating the database
            $Page->updateBlog2(array($_POST['blog_title'],$_POST['blog_meta_title'],$_POST['blog_meta_keyword'],$_POST['blog_meta_description']));
        }
...
if(isset($_POST['form_contact'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $Page->updateContact1(array($_POST['contact_title'],$final_name,$_POST['contact_meta_title'],$_POST['contact_meta_keyword'],$_POST['contact_meta_description']));
        } else {
            // updating the database
            $Page->updateContact2(array($_POST['contact_title'],$_POST['contact_meta_title'],$_POST['contact_meta_keyword'],$_POST['contact_meta_description']));
        }
...
if(isset($_POST['form_pgallery'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $Page->updateGallery1(array($_POST['pgallery_title'],$final_name,$_POST['pgallery_meta_title'],$_POST['pgallery_meta_keyword'],$_POST['pgallery_meta_description']));
        } else {
            // updating the database
            $Page->updateGallery2(array($_POST['pgallery_title'],$_POST['pgallery_meta_title'],$_POST['pgallery_meta_keyword'],$_POST['pgallery_meta_description']));
        }
...
if(isset($_POST['form_vgallery'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $Page->updateVGallery1(array($_POST['vgallery_title'],$final_name,$_POST['vgallery_meta_title'],$_POST['vgallery_meta_keyword'],$_POST['vgallery_meta_description']));
        } else {
            // updating the database
            $Page->updateVGallery2(array($_POST['vgallery_title'],$_POST['vgallery_meta_title'],$_POST['vgallery_meta_keyword'],$_POST['vgallery_meta_description']));
        }
