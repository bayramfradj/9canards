...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['post_title'])) {
		...
		$statement = $Post->exsisteTitle($_POST['post_title'],$current_post_title);
	...
	if($valid == 1) {
		...
		$statement = $Post->exsisteSlug($post_slug,$current_post_title);
		$total = $statement->rowCount();
		if($total) {
	    ...
	    if($previous_photo == '' && $path == '') {
	    	$Post->update(array($_POST['post_title'],$post_slug,$_POST['post_content'],$_POST['post_date'],$_POST['category_id'],$_POST['meta_title'],$_POST['meta_keyword'],$_POST['meta_description'],$_REQUEST['id']));
	    }
	    ...
	    if($previous_photo == '' && $path != '') {
	    	...
	    	$Post->update2(array($_POST['post_title'],$post_slug,$_POST['post_content'],$_POST['post_date'],$final_name,$_POST['category_id'],$_POST['meta_title'],$_POST['meta_keyword'],$_POST['meta_description'],$_REQUEST['id']));
	    }
