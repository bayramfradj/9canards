...
if(!isset($_SESSION['customer'])) {
    ...
    $statement = $customer->Inactive($_SESSION['customer']['cust_id'],0);
...
<div class="page">
    <div class="container">
        <div class="row">
            ...
            $statement = $payment->ListCryptoByUserId($_SESSION['customer']['cust_id']);
            ...
            $statement = $payment->ListCryptoByUserIdLimit($_SESSION['customer']['cust_id'],$start, $limit);
            ...
            ?>
                                ...
                                foreach ($result as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $statement1 = $orders->ListOrdersWithPayment($row['paymentID']);
                                        ...
                                        <td><?php echo $row['amountUSD'].LANG_VALUE_1; ?></td>
                                        <td><?php if($row['txConfirmed']==1) echo "Completed"; else echo "Pending"; ?></td>
