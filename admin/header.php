  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
    			...
    			if ($_SESSION['user']['role']=='Super Admin') {
			        ...
			        <li class="treeview <?php if( ($cur_page == 'order.php')||($cur_page == 'order_crypto.php') ) {echo 'active';} ?>">
			          <a href="#">
							<i class="fa fa-hand-o-right"></i>
						...
						<ul class="treeview-menu">
							<li><a href="order_crypto.php"><i class="fa fa-circle-o"></i> orders Bitcoin</a></li>
							<li><a href="order.php"><i class="fa fa-circle-o"></i> Other orders </a></li>
			        ...
			        <li class="treeview <?php if( ($cur_page == 'users.php') ||($cur_page == 'user-add.php') ) {echo 'active';} ?>">
						<a href="#">
							<i class="fa fa-hand-o-right"></i>
							<span>Users</span>
							<span class="pull-right-container">
