...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        $ShippingCost->insert(array($_POST['country_id'],$_POST['amount']));
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $ShippingCost->updateAll(array($_POST['amount']));
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="country_id" class="form-control select2">
                                    ...
                                    <?php
                                    $statement = $Country->all();
                                    $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                    foreach ($result as $row) {


                                        $statement = $ShippingCost->GetShippingByCuntry($row['country_id']);
