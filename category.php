...
$statement = $category->GetCategory($_REQUEST['slug']);
...
<div class="page">
    <div class="container">
        <div class="row">            
            ...
            $statement = $post->GetPostWithCategSlug($_REQUEST['slug']);
            ...
            $statement = $post->GetPostWithCategSlugLimit($_REQUEST['slug'],$start,$limit);
            $result = $statement->fetchAll(PDO::FETCH_ASSOC);
