...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $Settings->updateLogo($final_name);
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateFavicon($final_name);
...
if(isset($_POST['form3'])) {
    ...
    // updating the database
    $Settings->updateContact_Footer(array($_POST['newsletter_on_off'],$_POST['footer_about'],$_POST['footer_copyright'],$_POST['contact_address'],$_POST['contact_email'],$_POST['contact_phone'],$_POST['contact_fax'],$_POST['contact_map_iframe']));
...
if(isset($_POST['form4'])) {
    // updating the database
    $Settings->updateEmail(array($_POST['receive_email'],$_POST['receive_email_subject'],$_POST['receive_email_thank_you_message'],$_POST['forget_password_message']));
...
if(isset($_POST['form5'])) {
    // updating the database
    $Settings->updatePost(array($_POST['total_recent_post_footer'],$_POST['total_popular_post_footer'],$_POST['total_recent_post_sidebar'],$_POST['total_popular_post_sidebar'],$_POST['total_featured_product_home'],$_POST['total_latest_product_home'],$_POST['total_popular_product_home']));
...
if(isset($_POST['form6_0'])) {
    // updating the database
    $Settings->updateHome(array($_POST['home_service_on_off'],$_POST['home_welcome_on_off'],$_POST['home_featured_product_on_off'],$_POST['home_latest_product_on_off'],$_POST['home_popular_product_on_off'],$_POST['home_testimonial_on_off'],$_POST['home_blog_on_off']));
...
if(isset($_POST['form6'])) {
    // updating the database
    $Settings->updateMeta(array($_POST['meta_title_home'],$_POST['meta_keyword_home'],$_POST['meta_description_home']));
...
if(isset($_POST['form6_7'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $Settings->updateCTA1(array($_POST['cta_title'],$_POST['cta_content'],$_POST['cta_read_more_text'],$_POST['cta_read_more_url'],$final_name));
        } else {
            // updating the database
            $Settings->updateCTA2(array($_POST['cta_title'],$_POST['cta_content'],$_POST['cta_read_more_text'],$_POST['cta_read_more_url']));
        }
...
if(isset($_POST['form6_4'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateFPS(array($_POST['featured_product_title'],$_POST['featured_product_subtitle']));
...
if(isset($_POST['form6_5'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateLPS(array($_POST['latest_product_title'],$_POST['latest_product_subtitle']));
...
if(isset($_POST['form6_6'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updatePPS(array($_POST['popular_product_title'],$_POST['popular_product_subtitle']));
...
if(isset($_POST['form6_1'])) {
    ...
    if($valid == 1) {
        ...
        if($path != '') {
            ...
            // updating the database
            $Settings->updateTestimonial1(array($_POST['testimonial_title'],$_POST['testimonial_subtitle'],$final_name));
        } else {
            // updating the database
            $Settings->updateTestimonial2(array($_POST['testimonial_title'],$_POST['testimonial_subtitle']));
        }
...
if(isset($_POST['form6_2'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBlog(array($_POST['blog_title'],$_POST['blog_subtitle']));
...
if(isset($_POST['form6_3'])) {
        ...
        // updating the database
        $Settings->updateNewsletter(array($_POST['newsletter_text']));
...
if(isset($_POST['form7_1'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_login(array($final_name));
...
if(isset($_POST['form7_2'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_registration(array($final_name));
...
if(isset($_POST['form7_3'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_forget_password(array($final_name));
...
if(isset($_POST['form7_4'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_reset_password(array($final_name));
...
if(isset($_POST['form7_6'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_search(array($final_name));
...
if(isset($_POST['form7_7'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_cart(array($final_name));
...
if(isset($_POST['form7_8'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_checkout(array($final_name));
...
if(isset($_POST['form7_9'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_product_category(array($final_name));
...
if(isset($_POST['form7_10'])) {
    ...
    if($valid == 1) {
        ...
        // updating the database
        $Settings->updateBanner_blog(array($final_name));
...
if(isset($_POST['form9'])) {
    // updating the database
    $Settings->updatePayment(array($_POST['paypal_email'],$_POST['Bitcoin_private_key'],$_POST['Bitcoin_public_key'],$_POST['bank_detail']));
...
if(isset($_POST['form10'])) {
    // updating the database
    $Settings->updateScript(array($_POST['before_head'],$_POST['after_body'],$_POST['before_body']));
...
foreach ($result as $row) {
    ...
    $Bitcoin_private_key               = $row['Bitcoin_private_key'];
    $Bitcoin_public_key               = $row['Bitcoin_public_key'];
                            ...
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Bitcoin - Public Key </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="Bitcoin_public_key" class="form-control" value="<?php echo $Bitcoin_public_key; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Bitcoin - Secret Key </label>
                                            <div class="col-sm-5">
                                                <input type="text" name="Bitcoin_private_key" class="form-control" value="<?php echo $Bitcoin_private_key; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
