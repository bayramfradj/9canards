...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['category_name'])) {
		...
		$statement = $categ->exsist($_POST['category_name'],$current_category_name);
    ...
    if($valid == 1) {
		...
		$statement = $categ->exsistSlug($category_slug,$current_category_name);
		$total = $statement->rowCount();
		if($total) {
		...
		// updating into the database
		 $categ->update(array($_POST['category_name'],$category_slug,$_POST['meta_title'],$_POST['meta_keyword'],$_POST['meta_description'],$_REQUEST['id']));
