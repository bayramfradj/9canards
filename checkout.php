            ...
            <div class="col-md-12">
                ...
                <div class="cart">
                    <table class="table table-responsive">
                        ...
                        <?php
                        $statement = $ShippingCost->GetShippingByCuntry($_SESSION['customer']['cust_country']);
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-responsive table-bordered bill-address">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $statement = $country->GetCountry($_SESSION['customer']['cust_b_country']);
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($result as $row) {
	                	...
	                	<?php else: ?>
		                	<div class="col-md-4">
	                            ...
	                            <div class="row">
                                    ...
                                    <form class="paypal" action="<?php echo BASE_URL; ?>payment/bitcoin/payBitcoin.php" method="post" id="bitcoin_form" target="_blank">
                                       
                                        <input type="hidden" name="currency_code" value="USD" />
                                        
                                        <input type="hidden" name="final_total" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="<?php echo LANG_VALUE_46; ?>" name="form0">
                                        </div>
                                    </form>
